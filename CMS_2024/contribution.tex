...
\begin{abstract}
%
Developing transformation concepts to achieve net-zero emissions for production sites is a complex planning task. Mathematical optimization has been shown to be a suitable method in various applications. As current investment and deployment planning approaches neglect the economic reality of production sites by focusing on the reduction of greenhouse gases only, we present in this article a mathematical optimization approach that considers the energy productivity of a production site as an objective function. By integrating the production processes and the energy supply system in an unique modelling approach, economically feasible solutions are obtained.
%
\end{abstract}
