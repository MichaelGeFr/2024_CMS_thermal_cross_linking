...
\author[a]{Michael Frank\corref{*}} 
\author[a]{Fabian Borst}
\author[a]{Lukas Theisinger}
%\ead{author@institute.xxx}

\address[a]{Institute for Production Management, Technology and Machine Tools (PTW), Technical University of Darmstadt, Otto-Berndt-Str. 2, 64287 Darmstadt, Germany}
